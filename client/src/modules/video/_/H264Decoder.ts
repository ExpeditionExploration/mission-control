...
import init from './h264.wasm?init'
...
export default class H264Decoder {
    declare private pStorage: number;
    declare private pWidth: number;
    declare private pHeight: number;
    declare private pPicture: number;
    declare private decBuffer: number;
    declare private memory: ModuleMemory;
    declare private asm: H264Exports;
    ...
    declare public ready: Promise<void>;
    ...
    constructor() {
        this.ready = new Promise((resolve, reject) => {
            ...
            init({
                ...
                const asm = exports as H264Exports;
                console.log(asm);
                this.memory = memory;
                this.asm = asm;
